...
print("Extracting all games and direct download links...")
    ...
    if response.status_code == 200:
      ...
      if match:
        ...
        for app in paginator:
          ...
          # دەرهێنانی لینکی ڕەسەنی دابەزاندن
          ...
          app_entry = {
              ...
              "localizedDescription": (
                  "Downloaded from AshteMobile Source."
              ),
              "iconURL": (
                  image_url
                  if image_url
...
print(
    f"Successfully generated '{output_filename}' with {len(apps_list)} games!"
)
